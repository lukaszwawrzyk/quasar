...
object chroot {
  ...
  def readFile[S[a] <: ACopK[a]](prefix: ADir)(implicit S: ReadFile :<<: S): S ~> Free[S, ?] =
  ...
  def writeFile[S[a] <: ACopK[a]](prefix: ADir)(implicit S: WriteFile :<<: S): S ~> Free[S, ?] =
